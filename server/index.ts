...
app.use(
  cors({
    origin: [
      "https://ebhangar-fronted.onrender.com", // Render frontend (if needed)
...
(async () => {
  ...
  // ✅ Dev mode uses Vite; Production just runs backend
  if (app.get("env") === "development") {
    await setupVite(app, server);
  } else {
    log("🚀 Backend running in production mode (no frontend build).");
  }

  // ✅ PORT CONFIGURATION (Render safe)
